...
import Navbar from '../SuperAdminDashboard/Navbar'
...
const Dashboard = () => {
    ...
    useEffect(async () => {
        let approvedCondos = await axios.get("http://localhost:4000/approved-condos")
        setCondoList(...approvedCondos.data)
    }, [])
    return (
        <>
            <Sidebar />
                    ...
                    <span class="text-nowrap">Since last month</span>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="card card-stats">
                                        ...
                                        <div class="card-body">
                                            <Link to="/condo-approval" className="text-white">
                                            <div class="row">
                                                <div class="col">
                                                    <h5 class="card-title text-uppercase text-muted mb-0">Totsl Condos</h5>
                                                    <span class="h2 font-weight-bold mb-0">{condoList.length}</span>
                                                </div>
                                                <div class="col-auto">
