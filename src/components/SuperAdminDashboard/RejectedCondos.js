...
const RejectedCondos = () => {
    const [condoList, setCondoList] = useState([])

    useEffect(async () => {
        let rejectedCondos = await axios.get("http://localhost:4000/rejected-condos")
        setCondoList(...rejectedCondos.data)
    }, [])
                        ...
                        <div class="col">
                            <div class="card bg-default shadow">
                                ...
                                <div class="card-header bg-transparent border-0">
                                    <h3 class="mb-0 text-danger">Rejected Condos</h3>
                                </div>
